...
def compute_tmdb_match_probability(
    parsed_name: str | None, parsed_year: str | None, tmdb_title: str | None, tmdb_year: str | None
) -> float:
    """
    ...
    if not check_for_duplicates.empty:
        ...
        for i in conflicts:
            ...
            for original_file in fichiers_originaux:
                failed_files.append({"Original": original_file, "Reason": f"Conflict: Multiple files resolve to '{i}'"})
